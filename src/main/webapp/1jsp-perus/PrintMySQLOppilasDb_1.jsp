<%-- 
    Document   : PrintMySQLOppilasDb_1
...
<html>
	...
	try {
            ...
            //dbObj.connectDb();  //
            ResultSet rs = dbObj.Query("select id, nimi, demopisteet+koepisteet as total" +
                    " from oppilas order by id");
            ...
            rs = dbObj.Query("select nimi, demopisteet, koepisteet, demopisteet+koepisteet as total " +
